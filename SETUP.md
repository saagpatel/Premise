...
- Check the URL format: `https://your-project-ref.supabase.co` (no trailing slash)
...
- Private debates require Supabase Auth (Phase 3) — the RLS policies use `auth.uid()` which is null for anonymous users
